...
import Lover from "../../../public/asset/images/about_occo.png";
            ...
            <div className=" max-sm:h-auto w-full h-full  text-2xl	 font-bold	 tracking-wide	text-left  ">
              <div
                ...
                max-sm:min-w-[321px] max-sm:min-h-[68px] max-sm:text-[28px] max-[1360px]:text-[35px] leading-[80px]
                 max-[1360px]:leading-[50px] min-[1300px]:w-[700px]  max-sm:leading-[34px]"
              >
             NƠI TƯƠNG TÁC <br/> MANG LẠI CẢM XÚC
                </div>
            </div>
           <div className="pd-bottom-about w-full flex items-center min-[910px]:py-5" >
           <div
              ...
              style={{ color: "#817DA0" }}
            >
              {Content.HomeContent.description_about_occo}
            </div>
           </div>
